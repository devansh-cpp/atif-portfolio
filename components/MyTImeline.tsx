        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              ...
              width={250}
              height={250}
              className="rounded-lg object-cover bg-black shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
          Started my BBA (travel,toursim & hospitality in professional management) from University of Lucknow
               </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
             src="/university.jpg"
